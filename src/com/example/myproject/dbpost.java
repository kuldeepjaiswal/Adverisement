...
public class dbpost extends SQLiteOpenHelper{
    ...
    public String TableName;
     public String cat1,dep1,place1,description;
  ...
  /**
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	 ...
	 public Cursor getcur() {
		    String query="SELECT * FROM " + TableName +" where category ='" + cat1 + "' and department='"+dep1+"' and place='"+place1+"' and description='" + description +"'";
		    Log.d("query",query);
